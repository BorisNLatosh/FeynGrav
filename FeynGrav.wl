...
"GravitonVectorVertex[{\[Rho],\[Sigma],k}, \!\(\*SubscriptBox[\(\[Lambda]\), \(1\)]\), \!\(\*SubscriptBox[\(p\), \(1\)]\), \!\(\*SubscriptBox[\(\[Lambda]\), \(2\)]\), \!\(\*SubscriptBox[\(p\), \(2\)]\)]. Vertex for a massless vector field coupled to one graviton. The gauge-fixing parameter is already chosen and enters the expression. Here {\[Rho], \[Sigma]} are Lorentz indices of a graviton; k is a graviton momentum; {\!\(\*SubscriptBox[\(\[Lambda]\), \(i\)]\)} are Lorentz indices of vectors; {\!\(\*SubscriptBox[\(p\), \(i\)]\)} are momenta of vectors.\n\
GravitonVectorVertex[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\),\!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\),\!\(\*SubscriptBox[\(k\), \(1\)]\),\!\(\*SubscriptBox[\(\[Rho]\), \(2\)]\),\!\(\*SubscriptBox[\(\[Sigma]\), \(2\)]\),\!\(\*SubscriptBox[\(k\), \(2\)]\)}, \!\(\*SubscriptBox[\(\[Lambda]\), \(1\)]\), \!\(\*SubscriptBox[\(p\), \(1\)]\), \!\(\*SubscriptBox[\(\[Lambda]\), \(2\)]\), \!\(\*SubscriptBox[\(p\), \(2\)]\)]. Vertex for a massless vector field coupled to two gravitons. Here {\!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\)} are Lorentz indices of gravitons; \!\(\*SubscriptBox[\(k\), \(i\)]\) are graviton momenta; {\!\(\*SubscriptBox[\(\[Lambda]\), \(i\)]\)} are Lorentz indices of vectors; {\!\(\*SubscriptBox[\(p\), \(i\)]\)} are momenta of vectors.\n\
...
"GravitonQuarkGluonVertex[{\[Rho],\[Sigma]},\[Lambda],a]. Vertex for quark-gluon interaction coupled to one graviton. Here {\[Rho],\[Sigma]} are Lorentz indices of gravitons; \[Lambda] is the gluon Lorentz index; a is the gluon colour index.\n 
GravitonQuarkGluonVertex[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\),\!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\),\!\(\*SubscriptBox[\(\[Rho]\), \(2\)]\),\!\(\*SubscriptBox[\(\[Sigma]\), \(2\)]\)},\[Lambda],a]. Vertex for quark-gluon interaction coupled to two gravitons. Here {\!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\),\!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\)} are Lorentz indices of gravitons; \[Lambda] is the gluon Lorentz index; a is the gluon colour index.\n 
GravitonQuarkGluonVertex[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\),\!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\),\[Ellipsis],\!\(\*SubscriptBox[\(\[Rho]\), \(n\)]\),\!\(\*SubscriptBox[\(\[Sigma]\), \(n\)]\)},\[Lambda],a]. Vertex for quark-gluon interaction. Here {\!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\),\!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\)} are Lorentz indices of gravitons coupled to n gravitons; \[Lambda] is the gluon Lorentz index; a is the gluon colour index.";

GravitonYMGhostVertex::usage =
"GravitonYMGhostVertex[{\[Rho],\[Sigma]},\!\(\*SubscriptBox[\(p\), \(1\)]\),\!\(\*SubscriptBox[\(a\), \(1\)]\),\!\(\*SubscriptBox[\(p\), \(2\)]\),\!\(\*SubscriptBox[\(a\), \(2\)]\)]. Vertex for the Faddeev\[Dash]Popov ghost for gluons coupled to one graviton. Here {\[Rho],\[Sigma]} are Lorentz indices of a graviton; \!\(\*SubscriptBox[\(p\), \(i\)]\) are momenta of ghosts; \!\(\*SubscriptBox[\(a\), \(i\)]\) are colour indices of ghosts.\n
GravitonYMGhostVertex[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\),\!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\),\!\(\*SubscriptBox[\(\[Rho]\), \(2\)]\),\!\(\*SubscriptBox[\(\[Sigma]\), \(2\)]\)},\!\(\*SubscriptBox[\(p\), \(1\)]\),\!\(\*SubscriptBox[\(a\), \(1\)]\),\!\(\*SubscriptBox[\(p\), \(2\)]\),\!\(\*SubscriptBox[\(a\), \(2\)]\)]. Vertex for the Faddeev\[Dash]Popov ghost for gluons coupled to two gravitons. Here {\!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\),\!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\)} are Lorentz indices of gravitons; \!\(\*SubscriptBox[\(p\), \(i\)]\) are momenta of ghosts; \!\(\*SubscriptBox[\(a\), \(i\)]\) are colour indices of ghosts.\n
GravitonYMGhostVertex[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\),\!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\),\[Ellipsis],\!\(\*SubscriptBox[\(\[Rho]\), \(n\)]\),\!\(\*SubscriptBox[\(\[Sigma]\), \(n\)]\)},\!\(\*SubscriptBox[\(p\), \(1\)]\),\!\(\*SubscriptBox[\(a\), \(1\)]\),\!\(\*SubscriptBox[\(p\), \(2\)]\),\!\(\*SubscriptBox[\(a\), \(2\)]\)]. Vertex for the Faddeev\[Dash]Popov ghost for gluons coupled to n gravitons. Here {\!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\),\!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\)} are Lorentz indices of gravitons; \!\(\*SubscriptBox[\(p\), \(i\)]\) are momenta of ghosts; \!\(\*SubscriptBox[\(a\), \(i\)]\) are colour indices of ghosts.";

GravitonGluonGhostVertex::usage =
"GravitonGluonGhostVertex[{\[Rho],\[Sigma]},\!\(\*SubscriptBox[\(p\), \(1\)]\),\!\(\*SubscriptBox[\(\[Lambda]\), \(1\)]\),\!\(\*SubscriptBox[\(a\), \(1\)]\),\!\(\*SubscriptBox[\(p\), \(2\)]\),\!\(\*SubscriptBox[\(\[Lambda]\), \(2\)]\),\!\(\*SubscriptBox[\(a\), \(2\)]\),\!\(\*SubscriptBox[\(p\), \(3\)]\),\!\(\*SubscriptBox[\(\[Lambda]\), \(3\)]\),\!\(\*SubscriptBox[\(a\), \(3\)]\)]. Vertex for the Faddeev\[Dash]Popov ghost interaction with gluons coupled to one graviton. Here {\[Rho],\[Sigma]} are Lorentz indices of a graviton; \!\(\*SubscriptBox[\(\[Lambda]\), \(i\)]\) are Lorentz indices of gluons; \!\(\*SubscriptBox[\(p\), \(i\)]\) are momenta of ghosts and gluons; \!\(\*SubscriptBox[\(a\), \(i\)]\) are colour indices of ghosts and gluons. The order of momenta and colour indices matches the one used in FeynCalc.\n
...
"GravitonGhostVertexHD[\[Rho],\[Sigma],k,\[Mu],\!\(\*SubscriptBox[\(p\), \(1\)]\),\[Nu],\!\(\*SubscriptBox[\(p\), \(2\)]\)]. Vertex for the Faddeev\[Dash]Popov ghost in quadratic gravity with the higher derivative gauge fixing term obtained via the BRST formalism, coupled to one graviton. Here {\[Rho],\[Sigma]} are the graviton Lorentz indices and \(k\) is the graviton momentum; \[Mu] and \[Nu] are the ghost and antighost Lorentz indices; \!\(\*SubscriptBox[\(p\), \(1\)]\) and \!\(\*SubscriptBox[\(p\), \(2\)]\) are the ghost and antighost momenta.";
...
(* The code for FeynGravContractor was generated by ChatGPT and reviewed by a human. *)
