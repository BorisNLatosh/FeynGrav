...
"GravitonScalarVertex[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\), \[Ellipsis], \!\(\*SubscriptBox[\(\[Rho]\), \(n\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(n\)]\)}, \!\(\*SubscriptBox[\(p\), \(1\)]\), \!\(\*SubscriptBox[\(p\), \(2\)]\), m] gives the vertex describing the minimal coupling of n gravitons to a standard scalar field. The first argument is a flat list of graviton line parameters. Each graviton line is specified by a pair {\!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\)}, where \!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\) and \!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\) are the Lorentz indices of the graviton. The arguments \!\(\*SubscriptBox[\(p\), \(1\)]\) and \!\(\*SubscriptBox[\(p\), \(2\)]\) are the incoming momenta of the scalar lines. The parameter m is the scalar field mass and can be set to zero.
GravitonScalarVertex[{\[Rho], \[Sigma]}, \!\(\*SubscriptBox[\(p\), \(1\)]\), \!\(\*SubscriptBox[\(p\), \(2\)]\), m]
GravitonScalarVertex[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Rho]\), \(2\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(2\)]\)}, \!\(\*SubscriptBox[\(p\), \(1\)]\), \!\(\*SubscriptBox[\(p\), \(2\)]\), m]";


GravitonScalarPotentialVertex::usage = 
"GravitonScalarPotentialVertex[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\), \[Ellipsis], \!\(\*SubscriptBox[\(\[Rho]\), \(n\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(n\)]\)}, \!\(\*SubscriptBox[\(\[Lambda]\), \(p\)]\)] gives the vertex describing the minimal coupling of n gravitons to the scalar potential term (\!\(\*SubscriptBox[\(\[Lambda]\), \(p\)]\)/p!) \!\(\*SuperscriptBox[\(\[Phi]\), \(p\)]\). The first argument is a flat list of graviton line parameters. Each graviton line is specified by a pair {\!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\)}, where \!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\) and \!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\) are the Lorentz indices of the graviton. The parameter \!\(\*SubscriptBox[\(\[Lambda]\), \(p\)]\) is the coupling constant of the scalar potential term.
GravitonScalarPotentialVertex[{\[Rho], \[Sigma]}, \!\(\*SubscriptBox[\(\[Lambda]\), \(p\)]\)]
GravitonScalarPotentialVertex[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Rho]\), \(2\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(2\)]\)}, \!\(\*SubscriptBox[\(\[Lambda]\), \(p\)]\)]";
...
"GravitonFermionVertex[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\), \!\(\*SubscriptBox[\(k\), \(1\)]\), \[Ellipsis], \!\(\*SubscriptBox[\(\[Rho]\), \(n\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(n\)]\), \!\(\*SubscriptBox[\(k\), \(n\)]\)}, \!\(\*SubscriptBox[\(p\), \(1\)]\), \!\(\*SubscriptBox[\(p\), \(2\)]\), m] gives the vertex describing the minimal coupling of n gravitons to a standard Dirac fermion. The first argument is a flat list of graviton line parameters. Each graviton line is specified by a triple {\!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\), \!\(\*SubscriptBox[\(k\), \(i\)]\)}, where \!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\) and \!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\) are the Lorentz indices and \!\(\*SubscriptBox[\(k\), \(i\)]\) is the momentum. All momenta are incoming. The argument \!\(\*SubscriptBox[\(p\), \(1\)]\) is the incoming momentum of the fermion, while \!\(\*SubscriptBox[\(p\), \(2\)]\) is the incoming momentum of the antifermion. The parameter m is the fermion mass and can be set to zero.
GravitonFermionVertex[{\[Rho], \[Sigma], k}, \!\(\*SubscriptBox[\(p\), \(1\)]\), \!\(\*SubscriptBox[\(p\), \(2\)]\), m]
GravitonFermionVertex[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\), \!\(\*SubscriptBox[\(k\), \(1\)]\), \!\(\*SubscriptBox[\(\[Rho]\), \(2\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(2\)]\), \!\(\*SubscriptBox[\(k\), \(2\)]\)}, \!\(\*SubscriptBox[\(p\), \(1\)]\), \!\(\*SubscriptBox[\(p\), \(2\)]\), m]";
...
"GravitonMassiveVectorVertex[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\), \[Ellipsis], \!\(\*SubscriptBox[\(\[Rho]\), \(n\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(n\)]\)}, \!\(\*SubscriptBox[\(\[Lambda]\), \(1\)]\), \!\(\*SubscriptBox[\(p\), \(1\)]\), \!\(\*SubscriptBox[\(\[Lambda]\), \(2\)]\), \!\(\*SubscriptBox[\(p\), \(2\)]\), m] gives the vertex describing the minimal coupling of n gravitons to a massive vector field. The first argument is a flat list of graviton line parameters. Each graviton line is specified by a pair {\!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\)}, where \!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\) and \!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\) are the Lorentz indices of the graviton. The arguments \!\(\*SubscriptBox[\(\[Lambda]\), \(1\)]\) and \!\(\*SubscriptBox[\(\[Lambda]\), \(2\)]\) are the Lorentz indices of the vector lines, while \!\(\*SubscriptBox[\(p\), \(1\)]\) and \!\(\*SubscriptBox[\(p\), \(2\)]\) are their incoming momenta. The parameter m is the vector field mass.
GravitonMassiveVectorVertex[{\[Rho], \[Sigma]}, \!\(\*SubscriptBox[\(\[Lambda]\), \(1\)]\), \!\(\*SubscriptBox[\(p\), \(1\)]\), \!\(\*SubscriptBox[\(\[Lambda]\), \(2\)]\), \!\(\*SubscriptBox[\(p\), \(2\)]\), m]
GravitonMassiveVectorVertex[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Rho]\), \(2\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(2\)]\)}, \!\(\*SubscriptBox[\(\[Lambda]\), \(1\)]\), \!\(\*SubscriptBox[\(p\), \(1\)]\), \!\(\*SubscriptBox[\(\[Lambda]\), \(2\)]\), \!\(\*SubscriptBox[\(p\), \(2\)]\), m]";
...
"GravitonVectorGhostVertex[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\), \[Ellipsis], \!\(\*SubscriptBox[\(\[Rho]\), \(n\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(n\)]\)}, \!\(\*SubscriptBox[\(p\), \(1\)]\), \!\(\*SubscriptBox[\(p\), \(2\)]\)] gives the vertex describing the coupling of n gravitons to the Faddeev-Popov ghost associated with a massless vector field. The first argument is a flat list of graviton line parameters. Each graviton line is specified by a pair {\!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\)}, where \!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\) and \!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\) are the Lorentz indices of the graviton. The arguments \!\(\*SubscriptBox[\(p\), \(1\)]\) and \!\(\*SubscriptBox[\(p\), \(2\)]\) are the incoming momenta of the ghost lines.
GravitonVectorGhostVertex[{\[Rho], \[Sigma]}, \!\(\*SubscriptBox[\(p\), \(1\)]\), \!\(\*SubscriptBox[\(p\), \(2\)]\)]
GravitonVectorGhostVertex[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Rho]\), \(2\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(2\)]\)}, \!\(\*SubscriptBox[\(p\), \(1\)]\), \!\(\*SubscriptBox[\(p\), \(2\)]\)]";
...
"GravitonQuarkGluonVertex[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\), \[Ellipsis], \!\(\*SubscriptBox[\(\[Rho]\), \(n\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(n\)]\)}, \[Lambda], a] gives the vertex describing the coupling of n gravitons to the quark-antiquark-gluon interaction in the SU(N) Yang-Mills sector. The first argument is a flat list of graviton line parameters. Each graviton line is specified by a pair {\!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\)}, where \!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\) and \!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\) are the Lorentz indices of the graviton. The argument \[Lambda] is the Lorentz index of the gluon line, and a is its colour index.
GravitonQuarkGluonVertex[{\[Rho], \[Sigma]}, \[Lambda], a]
GravitonQuarkGluonVertex[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Rho]\), \(2\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(2\)]\)}, \[Lambda], a]";


GravitonYMGhostVertex::usage =
"GravitonYMGhostVertex[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\), \[Ellipsis], \!\(\*SubscriptBox[\(\[Rho]\), \(n\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(n\)]\)}, \!\(\*SubscriptBox[\(p\), \(1\)]\), \!\(\*SubscriptBox[\(a\), \(1\)]\), \!\(\*SubscriptBox[\(p\), \(2\)]\), \!\(\*SubscriptBox[\(a\), \(2\)]\)] gives the vertex describing the coupling of n gravitons to the Faddeev\[Dash]Popov ghost associated with the SU(N) Yang-Mills field. The first argument is a flat list of graviton line parameters. Each graviton line is specified by a pair {\!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\)}, where \!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\) and \!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\) are the Lorentz indices of the graviton. The arguments \!\(\*SubscriptBox[\(p\), \(1\)]\) and \!\(\*SubscriptBox[\(p\), \(2\)]\) are the incoming momenta of the ghost lines, while \!\(\*SubscriptBox[\(a\), \(1\)]\) and \!\(\*SubscriptBox[\(a\), \(2\)]\) are their colour indices.
GravitonYMGhostVertex[{\[Rho], \[Sigma]}, \!\(\*SubscriptBox[\(p\), \(1\)]\), \!\(\*SubscriptBox[\(a\), \(1\)]\), \!\(\*SubscriptBox[\(p\), \(2\)]\), \!\(\*SubscriptBox[\(a\), \(2\)]\)]
GravitonYMGhostVertex[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Rho]\), \(2\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(2\)]\)}, \!\(\*SubscriptBox[\(p\), \(1\)]\), \!\(\*SubscriptBox[\(a\), \(1\)]\), \!\(\*SubscriptBox[\(p\), \(2\)]\), \!\(\*SubscriptBox[\(a\), \(2\)]\)]";
...
"GravitonVertex[\!\(\*SubscriptBox[\(\[Mu]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Nu]\), \(1\)]\), \!\(\*SubscriptBox[\(p\), \(1\)]\), \[Ellipsis], \!\(\*SubscriptBox[\(\[Mu]\), \(n\)]\), \!\(\*SubscriptBox[\(\[Nu]\), \(n\)]\), \!\(\*SubscriptBox[\(p\), \(n\)]\)] gives the n-graviton self-interaction vertex in general relativity for n \!\(\*FormBox[\"\\[GreaterEqual]\", TraditionalForm]\) 3. The arguments are grouped into graviton line triples {\!\(\*SubscriptBox[\(\[Mu]\), \(i\)]\), \!\(\*SubscriptBox[\(\[Nu]\), \(i\)]\), \!\(\*SubscriptBox[\(p\), \(i\)]\)}, where \!\(\*SubscriptBox[\(\[Mu]\), \(i\)]\) and \!\(\*SubscriptBox[\(\[Nu]\), \(i\)]\) are the Lorentz indices and \!\(\*SubscriptBox[\(p\), \(i\)]\) is the momentum. All momenta are incoming. The gauge-fixing parameter GaugeFixingEpsilon controls the graviton propagator and does not enter this vertex.
GravitonVertex[\!\(\*SubscriptBox[\(\[Mu]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Nu]\), \(1\)]\), \!\(\*SubscriptBox[\(p\), \(1\)]\), \!\(\*SubscriptBox[\(\[Mu]\), \(2\)]\), \!\(\*SubscriptBox[\(\[Nu]\), \(2\)]\), \!\(\*SubscriptBox[\(p\), \(2\)]\), \!\(\*SubscriptBox[\(\[Mu]\), \(3\)]\), \!\(\*SubscriptBox[\(\[Nu]\), \(3\)]\), \!\(\*SubscriptBox[\(p\), \(3\)]\)]
GravitonVertex[\!\(\*SubscriptBox[\(\[Mu]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Nu]\), \(1\)]\), \!\(\*SubscriptBox[\(p\), \(1\)]\), \!\(\*SubscriptBox[\(\[Mu]\), \(2\)]\), \!\(\*SubscriptBox[\(\[Nu]\), \(2\)]\), \!\(\*SubscriptBox[\(p\), \(2\)]\), \!\(\*SubscriptBox[\(\[Mu]\), \(3\)]\), \!\(\*SubscriptBox[\(\[Nu]\), \(3\)]\), \!\(\*SubscriptBox[\(p\), \(3\)]\), \!\(\*SubscriptBox[\(\[Mu]\), \(4\)]\), \!\(\*SubscriptBox[\(\[Nu]\), \(4\)]\), \!\(\*SubscriptBox[\(p\), \(4\)]\)]";


GravitonGhostVertex::usage =
"GravitonGhostVertex[\[Rho], \[Sigma], k, \[Mu], \!\(\*SubscriptBox[\(p\), \(1\)]\), \[Nu], \!\(\*SubscriptBox[\(p\), \(2\)]\)] gives the vertex describing the coupling of one graviton to the Faddeev\[Dash]Popov ghost of general relativity obtained via the BRST formalism. The arguments \[Rho], \[Sigma], and k specify the graviton line, where \[Rho] and \[Sigma] are the Lorentz indices and k is the momentum. The arguments \[Mu] and \!\(\*SubscriptBox[\(p\), \(1\)]\) specify the ghost line, while \[Nu] and \!\(\*SubscriptBox[\(p\), \(2\)]\) specify the antighost line. All momenta are incoming.";
...
"GravitonVertexCRhhh[\!\(\*SubscriptBox[\(\[Mu]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Nu]\), \(1\)]\), \!\(\*SubscriptBox[\(p\), \(1\)]\), \!\(\*SubscriptBox[\(\[Mu]\), \(2\)]\), \!\(\*SubscriptBox[\(\[Nu]\), \(2\)]\), \!\(\*SubscriptBox[\(p\), \(2\)]\), \!\(\*SubscriptBox[\(\[Mu]\), \(3\)]\), \!\(\*SubscriptBox[\(\[Nu]\), \(3\)]\), \!\(\*SubscriptBox[\(p\), \(3\)]\)] gives the cubic self-interaction vertex for three Cheung-Remmen metric perturbations in general relativity. The arguments are grouped into graviton line triples {\!\(\*SubscriptBox[\(\[Mu]\), \(i\)]\), \!\(\*SubscriptBox[\(\[Nu]\), \(i\)]\), \!\(\*SubscriptBox[\(p\), \(i\)]\)}, where \!\(\*SubscriptBox[\(\[Mu]\), \(i\)]\) and \!\(\*SubscriptBox[\(\[Nu]\), \(i\)]\) are the Lorentz indices and \!\(\*SubscriptBox[\(p\), \(i\)]\) is the momentum.";


GravitonVertexCRBhh::usage =
"GravitonVertexCRBhh[\[Alpha], \[Rho], \[Sigma], \!\(\*SubscriptBox[\(\[Mu]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Nu]\), \(1\)]\), \!\(\*SubscriptBox[\(p\), \(1\)]\), \!\(\*SubscriptBox[\(\[Mu]\), \(2\)]\), \!\(\*SubscriptBox[\(\[Nu]\), \(2\)]\), \!\(\*SubscriptBox[\(p\), \(2\)]\)] gives the cubic interaction vertex for one Cheung-Remmen auxiliary field and two Cheung-Remmen metric perturbations in general relativity. The arguments \[Alpha], \[Rho], and \[Sigma] specify the auxiliary-field line \!\(\*SuperscriptBox[\(B\), \(\[Alpha]\)]\)\!\(\*SubscriptBox[\(\), \(\[Rho]\[Sigma]\)]\). The remaining arguments are grouped into graviton line triples {\!\(\*SubscriptBox[\(\[Mu]\), \(i\)]\), \!\(\*SubscriptBox[\(\[Nu]\), \(i\)]\), \!\(\*SubscriptBox[\(p\), \(i\)]\)}, where \!\(\*SubscriptBox[\(\[Mu]\), \(i\)]\) and \!\(\*SubscriptBox[\(\[Nu]\), \(i\)]\) are the Lorentz indices and \!\(\*SubscriptBox[\(p\), \(i\)]\) is the momentum.";
...
"GravitonAxionVectorVertex[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\), \[Ellipsis], \!\(\*SubscriptBox[\(\[Rho]\), \(n\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(n\)]\)}, \!\(\*SubscriptBox[\(\[Lambda]\), \(1\)]\), \!\(\*SubscriptBox[\(q\), \(1\)]\), \!\(\*SubscriptBox[\(\[Lambda]\), \(2\)]\), \!\(\*SubscriptBox[\(q\), \(2\)]\), \[Theta]] gives the vertex describing the coupling of n gravitons to the axion-like scalar-vector-vector interaction. The first argument is a flat list of graviton line parameters. Each graviton line is specified by a pair {\!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\)}, where \!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\) and \!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\) are the Lorentz indices of the graviton. The arguments \!\(\*SubscriptBox[\(\[Lambda]\), \(1\)]\) and \!\(\*SubscriptBox[\(\[Lambda]\), \(2\)]\) are the Lorentz indices of the vector lines, while \!\(\*SubscriptBox[\(q\), \(1\)]\) and \!\(\*SubscriptBox[\(q\), \(2\)]\) are their incoming momenta. The parameter \[Theta] is the coupling constant of the axion-like interaction.
GravitonAxionVectorVertex[{\[Rho], \[Sigma]}, \!\(\*SubscriptBox[\(\[Lambda]\), \(1\)]\), \!\(\*SubscriptBox[\(q\), \(1\)]\), \!\(\*SubscriptBox[\(\[Lambda]\), \(2\)]\), \!\(\*SubscriptBox[\(q\), \(2\)]\), \[Theta]]
GravitonAxionVectorVertex[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Rho]\), \(2\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(2\)]\)}, \!\(\*SubscriptBox[\(\[Lambda]\), \(1\)]\), \!\(\*SubscriptBox[\(q\), \(1\)]\), \!\(\*SubscriptBox[\(\[Lambda]\), \(2\)]\), \!\(\*SubscriptBox[\(q\), \(2\)]\), \[Theta]]";
...
HorndeskiG2::usage = 
"HorndeskiG2[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\), \[Ellipsis], \!\(\*SubscriptBox[\(\[Rho]\), \(n\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(n\)]\)}, {\!\(\*SubscriptBox[\(p\), \(1\)]\), \[Ellipsis], \!\(\*SubscriptBox[\(p\), \(a + 2 b\)]\)}, b, \[Lambda]] gives the vertex describing the coupling of n gravitons to the Horndeski \!\(\*SubscriptBox[\(G\), \(2\)]\) sector for the monomial \!\(\*SubscriptBox[\(G\), \(2\)]\) = \[Lambda] \!\(\*SuperscriptBox[\(\[Phi]\), \(a\)]\) \!\(\*SuperscriptBox[\(X\), \(b\)]\). The first argument is a flat list of graviton line parameters. Each graviton line is specified by a pair {\!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\)}, where \!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\) and \!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\) are the Lorentz indices of the graviton. The second argument is the list of incoming scalar momenta. The parameter b is the number of kinetic factors X, and \[Lambda] is the coupling constant.
HorndeskiG2[{\[Rho], \[Sigma]}, {\!\(\*SubscriptBox[\(p\), \(1\)]\), \[Ellipsis], \!\(\*SubscriptBox[\(p\), \(a + 2 b\)]\)}, b, \[Lambda]]
HorndeskiG2[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Rho]\), \(2\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(2\)]\)}, {\!\(\*SubscriptBox[\(p\), \(1\)]\), \[Ellipsis], \!\(\*SubscriptBox[\(p\), \(a + 2 b\)]\)}, b, \[Lambda]]";


HorndeskiG3::usage = 
"HorndeskiG3[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\), \!\(\*SubscriptBox[\(k\), \(1\)]\), \[Ellipsis], \!\(\*SubscriptBox[\(\[Rho]\), \(n\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(n\)]\), \!\(\*SubscriptBox[\(k\), \(n\)]\)}, {\!\(\*SubscriptBox[\(p\), \(1\)]\), \[Ellipsis], \!\(\*SubscriptBox[\(p\), \(a + 2 b + 1\)]\)}, b, \[Lambda]] gives the vertex describing the coupling of n gravitons to the Horndeski \!\(\*SubscriptBox[\(G\), \(3\)]\) sector for the monomial \!\(\*SubscriptBox[\(G\), \(3\)]\) = \[Lambda] \!\(\*SuperscriptBox[\(\[Phi]\), \(a\)]\) \!\(\*SuperscriptBox[\(X\), \(b\)]\). The first argument is a flat list of graviton line parameters. Each graviton line is specified by a triple {\!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\), \!\(\*SubscriptBox[\(k\), \(i\)]\)}, where \!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\) and \!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\) are the Lorentz indices of the graviton and \!\(\*SubscriptBox[\(k\), \(i\)]\) is its momentum. The second argument is the list of incoming scalar momenta. The parameter b is the number of kinetic factors X, and \[Lambda] is the coupling constant. All momenta are incoming.
HorndeskiG3[{\[Rho], \[Sigma], k}, {\!\(\*SubscriptBox[\(p\), \(1\)]\), \[Ellipsis], \!\(\*SubscriptBox[\(p\), \(a + 2 b + 1\)]\)}, b, \[Lambda]]
HorndeskiG3[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\), \!\(\*SubscriptBox[\(k\), \(1\)]\), \!\(\*SubscriptBox[\(\[Rho]\), \(2\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(2\)]\), \!\(\*SubscriptBox[\(k\), \(2\)]\)}, {\!\(\*SubscriptBox[\(p\), \(1\)]\), \[Ellipsis], \!\(\*SubscriptBox[\(p\), \(a + 2 b + 1\)]\)}, b, \[Lambda]]";


HorndeskiG4::usage = 
"HorndeskiG4[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\), \!\(\*SubscriptBox[\(k\), \(1\)]\), \[Ellipsis], \!\(\*SubscriptBox[\(\[Rho]\), \(n\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(n\)]\), \!\(\*SubscriptBox[\(k\), \(n\)]\)}, {\!\(\*SubscriptBox[\(p\), \(1\)]\), \[Ellipsis], \!\(\*SubscriptBox[\(p\), \(a + 2 b\)]\)}, b, \[Lambda]] gives the vertex describing the coupling of n gravitons to the Horndeski \!\(\*SubscriptBox[\(G\), \(4\)]\) sector for the monomial \!\(\*SubscriptBox[\(G\), \(4\)]\) = \[Lambda] \!\(\*SuperscriptBox[\(\[Phi]\), \(a\)]\) \!\(\*SuperscriptBox[\(X\), \(b\)]\). The first argument is a flat list of graviton line parameters. Each graviton line is specified by a triple {\!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\), \!\(\*SubscriptBox[\(k\), \(i\)]\)}, where \!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\) and \!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\) are the Lorentz indices of the graviton and \!\(\*SubscriptBox[\(k\), \(i\)]\) is its momentum. The second argument is the list of incoming scalar momenta. The parameter b is the number of kinetic factors X, and \[Lambda] is the coupling constant. All momenta are incoming.
HorndeskiG4[{\[Rho], \[Sigma], k}, {\!\(\*SubscriptBox[\(p\), \(1\)]\), \[Ellipsis], \!\(\*SubscriptBox[\(p\), \(a + 2 b\)]\)}, b, \[Lambda]]
HorndeskiG4[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\), \!\(\*SubscriptBox[\(k\), \(1\)]\), \!\(\*SubscriptBox[\(\[Rho]\), \(2\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(2\)]\), \!\(\*SubscriptBox[\(k\), \(2\)]\)}, {\!\(\*SubscriptBox[\(p\), \(1\)]\), \[Ellipsis], \!\(\*SubscriptBox[\(p\), \(a + 2 b\)]\)}, b, \[Lambda]]";


HorndeskiG5::usage = 
"HorndeskiG5[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\), \!\(\*SubscriptBox[\(k\), \(1\)]\), \[Ellipsis], \!\(\*SubscriptBox[\(\[Rho]\), \(n\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(n\)]\), \!\(\*SubscriptBox[\(k\), \(n\)]\)}, {\!\(\*SubscriptBox[\(p\), \(1\)]\), \[Ellipsis], \!\(\*SubscriptBox[\(p\), \(a + 2 b + 1\)]\)}, b, \[Lambda]] gives the vertex describing the coupling of n gravitons to the Horndeski \!\(\*SubscriptBox[\(G\), \(5\)]\) sector for the monomial \!\(\*SubscriptBox[\(G\), \(5\)]\) = \[Lambda] \!\(\*SuperscriptBox[\(\[Phi]\), \(a\)]\) \!\(\*SuperscriptBox[\(X\), \(b\)]\). The first argument is a flat list of graviton line parameters. Each graviton line is specified by a triple {\!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\), \!\(\*SubscriptBox[\(k\), \(i\)]\)}, where \!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\) and \!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\) are the Lorentz indices of the graviton and \!\(\*SubscriptBox[\(k\), \(i\)]\) is its momentum. The second argument is the list of incoming scalar momenta. The parameter b is the number of kinetic factors X, and \[Lambda] is the coupling constant. All momenta are incoming.
HorndeskiG5[{\[Rho], \[Sigma], k}, {\!\(\*SubscriptBox[\(p\), \(1\)]\), \[Ellipsis], \!\(\*SubscriptBox[\(p\), \(a + 2 b + 1\)]\)}, b, \[Lambda]]
HorndeskiG5[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\), \!\(\*SubscriptBox[\(k\), \(1\)]\), \!\(\*SubscriptBox[\(\[Rho]\), \(2\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(2\)]\), \!\(\*SubscriptBox[\(k\), \(2\)]\)}, {\!\(\*SubscriptBox[\(p\), \(1\)]\), \[Ellipsis], \!\(\*SubscriptBox[\(p\), \(a + 2 b + 1\)]\)}, b, \[Lambda]]";
...
"ScalarGaussBonnet[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\), \!\(\*SubscriptBox[\(k\), \(1\)]\), \[Ellipsis], \!\(\*SubscriptBox[\(\[Rho]\), \(n\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(n\)]\), \!\(\*SubscriptBox[\(k\), \(n\)]\)}, g] gives the vertex describing the coupling of n gravitons to the scalar-Gauss-Bonnet interaction for n \!\(\*FormBox[\"\\[GreaterEqual]\", TraditionalForm]\) 2. The first argument is a flat list of graviton line parameters. Each graviton line is specified by a triple {\!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\), \!\(\*SubscriptBox[\(k\), \(i\)]\)}, where \!\(\*SubscriptBox[\(\[Rho]\), \(i\)]\) and \!\(\*SubscriptBox[\(\[Sigma]\), \(i\)]\) are the Lorentz indices of the graviton and \!\(\*SubscriptBox[\(k\), \(i\)]\) is its momentum. The parameter g is the scalar-Gauss-Bonnet coupling. All momenta are incoming.
ScalarGaussBonnet[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\), \!\(\*SubscriptBox[\(k\), \(1\)]\), \!\(\*SubscriptBox[\(\[Rho]\), \(2\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(2\)]\), \!\(\*SubscriptBox[\(k\), \(2\)]\)}, g]
ScalarGaussBonnet[{\!\(\*SubscriptBox[\(\[Rho]\), \(1\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(1\)]\), \!\(\*SubscriptBox[\(k\), \(1\)]\), \!\(\*SubscriptBox[\(\[Rho]\), \(2\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(2\)]\), \!\(\*SubscriptBox[\(k\), \(2\)]\), \!\(\*SubscriptBox[\(\[Rho]\), \(3\)]\), \!\(\*SubscriptBox[\(\[Sigma]\), \(3\)]\), \!\(\*SubscriptBox[\(k\), \(3\)]\)}, g]";
...
FormatValues[FeynGrav`GaugeFixingEpsilonHD] = {HoldPattern[MakeBoxes[FeynGrav`GaugeFixingEpsilonHD,TraditionalForm]]:>SubscriptBox["\[CurlyEpsilon]","Gravity,HD"]} ;
FormatValues[FeynGrav`GaugeFixingEpsilonHD0] = {HoldPattern[MakeBoxes[FeynGrav`GaugeFixingEpsilonHD0,TraditionalForm]]:>SubscriptBox["\[CurlyEpsilon]","Gravity,HD,0"]} ;
FormatValues[FeynGrav`GaugeFixingEpsilonHD1] = {HoldPattern[MakeBoxes[FeynGrav`GaugeFixingEpsilonHD1,TraditionalForm]]:>SubscriptBox["\[CurlyEpsilon]","Gravity,HD,1"]} ;
...
(* Gauge-fixing parameter for the graviton propagator in the Cheung-Remmen variables; the default value -1/2 gives the simple form of GravitonPropagatorCR. See FeynGrav 4.0, Secs. 3 and 4. *)

FeynGrav`GaugeFixingEpsilonVector = -1;
(* Gauge-fixing parameter for a single massless vector field in curved spacetime; the default value -1 is used for vector-field vertices and propagators. See FeynGrav 2.0, Sec. 2.3 and Appendix A. *)

FeynGrav`GaugeFixingEpsilonSUNYM = -1;
(* Gauge-fixing parameter for the SU(N) Yang-Mills sector in curved spacetime; the default value -1 is used for gluon and Yang-Mills ghost rules. See FeynGrav 2.0, Sec. 3 and Appendix A. *)
...
GravitonPropagator[\[Mu]_,\[Nu]_,\[Alpha]_,\[Beta]_,p_] := I FAD[p] NieuwenhuizenOperator[FeynGrav`GaugeFixingEpsilon/2 , 1 , (D-5)/(D-2) , ( (D-1)(FeynGrav`GaugeFixingEpsilon-1) -FeynGrav`GaugeFixingEpsilon)/(D-2) , -1/(D-2) ,\[Mu],\[Nu],\[Alpha],\[Beta],p] //FeynAmpDenominatorCombine//Simplify ;


GhostVectorPropagator[\[Mu]_,\[Nu]_,p_] := (I) MTD[\[Mu],\[Nu]] FAD[p];
...
QuadraticGravityPropagator[\[Mu]_,\[Nu]_,\[Alpha]_,\[Beta]_,p_,m0_,m2_]:= GravitonPropagator[\[Mu],\[Nu],\[Alpha],\[Beta],p] - NieuwenhuizenOperator[0,1,(D-4)/(D-1),0,0,\[Mu],\[Nu],\[Alpha],\[Beta],p](I)FAD[{p,m2}] + 1/(D-2) NieuwenhuizenOperator[0,0,3/(D-1),(D-1),1,\[Mu],\[Nu],\[Alpha],\[Beta],p](I)FAD[{p, Sqrt[3(D-2)m0^2 m2^2/(  (D-4) m0^2 + 2(D-1)m2^2 )]}];
