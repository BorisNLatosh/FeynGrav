...
CTensorPlain[indexArray_List] := 
	CTensorPlain[indexArray] = 
		(1/Length[indexArray])*
		Sum[
			(-1)^(i - 1) ITensorPlain[indexArray[[;; 2 i]]] CTensorPlain[indexArray[[2 i + 1 ;;]]] ,
...
CTensor[indexArray_List] := 
	CTensor[indexArray] = 
		1/Power[2, Length[indexArray]/2] 1/Factorial[Length[indexArray]/2] Total[ Map[ CTensorPlain , indexArraySymmetrization[indexArray] ] ] ;
...
C1TensorPlain[indexArrayExternal_List, indexArrayInternal_List] := 
	C1TensorPlain[indexArrayExternal, indexArrayInternal] =  
		If[ 
			Length[indexArrayExternal] == 0, 
			0,
			Sum[
				Power[-1, i] ITensorPlain[Join[indexArrayExternal, indexArrayInternal[[;; 2 i]]]] CTensorPlain[indexArrayInternal[[2 i + 1 ;;]]],
...
C1Tensor[indexArrayExternal_, indexArrayInternal_] := 
	C1Tensor[indexArrayExternal, indexArrayInternal] = 
		...
		Total[
			Map[
				C1TensorPlain[indexArrayExternal,#]& ,
...
C2TensorPlain[indexArrayExternal_,indexArrayInternal_] := 
	C2TensorPlain[indexArrayExternal,indexArrayInternal] = 
		If[
			...
			0,
			Sum[
				Power[-1,i] ITensorPlain[ Join[indexArrayExternal[[;;2]],indexArrayInternal[[;;2 i]]] ] C1TensorPlain[indexArrayExternal[[3;;]],indexArrayInternal[[2 i + 1;;]]] , 
				{i,0,Length[indexArrayInternal]/2}
			] 
		];
...
C2Tensor[indexArrayExternal_,indexArrayInternal_] := 
	C2Tensor[indexArrayExternal,indexArrayInternal] = 
		...
		Total[
			Map[
				C2TensorPlain[indexArrayExternal,#]&,
				indexArraySymmetrization[indexArrayInternal]
			]
		];
...
C3TensorPlain[indexArrayExternal_,indexArrayInternal_] := 
	C3TensorPlain[indexArrayExternal,indexArrayInternal] = 
		If[ 
			...
			0,
			Sum[
				Power[-1,i] ITensorPlain[ Join[indexArrayExternal[[;;2]],indexArrayInternal[[;;2 i]]] ] C2TensorPlain[indexArrayExternal[[3;;]],indexArrayInternal[[2 i+1;;]]] ,
				{i,0,Length[indexArrayInternal]/2}
			]
		];
...
C3Tensor[indexArrayExternal_,indexArrayInternal_] := 
	C3Tensor[indexArrayExternal,indexArrayInternal] = 
		...
		Total[
			Map[
				C3TensorPlain[indexArrayExternal,#]&,
				indexArraySymmetrization[indexArrayInternal]
			]
		];
...
C4TensorPlain[indexArrayExternal_,indexArrayInternal_] := 
	C4TensorPlain[indexArrayExternal,indexArrayInternal] = 
		If[
			...
			0,
			Sum[ 
				Power[-1,i] ITensorPlain[ Join[indexArrayExternal[[;;2]],indexArrayInternal[[;;2 i]]] ] C3TensorPlain[indexArrayExternal[[3;;]],indexArrayInternal[[2 i+1;;]]],
				{i,0,Length[indexArrayInternal]/2}
			]
		];
...
C4Tensor[indexArrayExternal_,indexArrayInternal_] := 
	C4Tensor[indexArrayExternal,indexArrayInternal] = 
		...
		Total[
			Map[
				C4TensorPlain[indexArrayExternal,#]&,
				indexArraySymmetrization[indexArrayInternal]
			]
		];
...
C5TensorPlain[indexArrayExternal_,indexArrayInternal_] := 
	C5TensorPlain[indexArrayExternal,indexArrayInternal] = 
		If[
			...
			0,
			Sum[
				Power[-1,i] ITensorPlain[ Join[indexArrayExternal[[;;2]],indexArrayInternal[[;;2 i]]] ] C4TensorPlain[indexArrayExternal[[3;;]],indexArrayInternal[[2 i+1;;]]],
				{i,0,Length[indexArrayInternal]/2}
			]
		];
...
C6TensorPlain[indexArrayExternal_,indexArrayInternal_] := 
	C6TensorPlain[indexArrayExternal,indexArrayInternal] = 
		If[
			...
			0,
			Sum[ 
				Power[-1,i] ITensorPlain[ Join[indexArrayExternal[[;;2]],indexArrayInternal[[;;2 i]]] ] C5TensorPlain[indexArrayExternal[[3;;]],indexArrayInternal[[2 i+1;;]]],
				{i,0,Length[indexArrayInternal]/2}
			]
		];
...
C6Tensor[indexArrayExternal_,indexArrayInternal_] := 
	C6Tensor[indexArrayExternal,indexArrayInternal] = 
		...
		Total[
			Map[
				C6TensorPlain[indexArrayExternal,#]&,
				indexArraySymmetrization[indexArrayInternal]
			]
		];
...
C7TensorPlain[indexArrayExternal_,indexArrayInternal_] := 
	C7TensorPlain[indexArrayExternal,indexArrayInternal] = 
		If[
			...
			0,
			Sum[
				Power[-1,i] ITensorPlain[ Join[indexArrayExternal[[;;2]],indexArrayInternal[[;;2 i]]] ] C6TensorPlain[indexArrayExternal[[3;;]],indexArrayInternal[[2 i+1;;]]] ,
				{i,0,Length[indexArrayInternal]/2}
			]
		];
