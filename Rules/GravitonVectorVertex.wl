...
GravitonVectorGhostVertex = {indexArray,p1,p2} |-> I (FeynGrav`\[Kappa])^(Length[indexArray]/2) Contract[- FVD[p1,\[ScriptM]]FVD[p2,\[ScriptN]] CITensor[{\[ScriptM],\[ScriptN]},indexArray]]//Expand;
