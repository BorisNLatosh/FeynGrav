...
GravitonVectorVertex4 = {indexArray,\[Lambda]1,p1,\[Lambda]2,p2} |->Total[Function[GravitonVectorVertex4a[#,\[Lambda]1,p1,\[Lambda]2,p2]]/@(Flatten/@Permutations[Partition[indexArray,3]])]//Contrac;
...
GravitonVectorGhostVertex = {indexArray,p1,p2} |-> I (Global`\[Kappa])^(Length[indexArray]/2) Contrac[- FVD[p1,\[ScriptM]]FVD[p2,\[ScriptN]] CITensor[{\[ScriptM],\[ScriptN]},indexArray]]//Expand;
