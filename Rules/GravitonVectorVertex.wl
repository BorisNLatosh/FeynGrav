...
GravitonVectorVertex3 = {indexArray,\[Lambda]1,p1,\[Lambda]2,p2} |-> I (Global`\[Kappa])^(Length[indexArray]/3) CTensor[TakeLorenzIndices[indexArray]] (-(1/2))FVD[p1,\[Lambda]1]FVD[p2,\[Lambda]2] //Calc;
GravitonVectorVertex4a = {indexArray,\[Lambda]1,p1,\[Lambda]2,p2} |-> I (Global`\[Kappa])^(Length[indexArray]/3) CITensor[{\[Mu],\[Nu]},TakeLorenzIndices[indexArray[[4;;]]]] (1/2)(-(1/2)GammaReduced[\[Mu],\[Lambda]1,\[Nu],\[Lambda],indexArray[[1]],indexArray[[2]]]FVD[indexArray[[3]],\[Lambda]]FVD[p2,\[Lambda]2]-(1/2) GammaReduced[\[Mu],\[Lambda]2,\[Nu],\[Lambda],indexArray[[1]],indexArray[[2]]]FVD[indexArray[[3]],\[Lambda]]FVD[p1,\[Lambda]1]) //Calc;
...
GravitonVectorVertex5a = {indexArray,\[Lambda]1,p1,\[Lambda]2,p2} |-> I (Global`\[Kappa])^(Length[indexArray]/3) CIITensor[{\[Mu],\[Nu],\[Alpha],\[Beta]},TakeLorenzIndices[indexArray[[7;;]]]](-1/8)FVD[indexArray[[3]],\[Tau]1]FVD[indexArray[[6]],\[Tau]2]   (1/2)(GammaReduced[\[Mu],\[Lambda]1,\[Nu],\[Tau]1,indexArray[[1]],indexArray[[2]]] GammaReduced[\[Alpha],\[Lambda]2,\[Beta],\[Tau]2,indexArray[[4]],indexArray[[5]]] + GammaReduced[\[Mu],\[Lambda]2,\[Nu],\[Tau]1,indexArray[[1]],indexArray[[2]]] GammaReduced[\[Alpha],\[Lambda]1,\[Beta],\[Tau]2,indexArray[[4]],indexArray[[5]]] )// Calc;
