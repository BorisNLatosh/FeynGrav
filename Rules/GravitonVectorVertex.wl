...
GravitonMassiveVectorVertex[indexArray_,\[Lambda]1_,p1_,\[Lambda]2_,p2_,m_] := 
	GravitonMassiveVectorVertex[indexArray,\[Lambda]1,p1,\[Lambda]2,p2,m] = 
		I (Global`\[Kappa])^(Length[indexArray]/2) ( (1/2) CTensorGeneral[{\[Mu],\[Alpha],\[Nu],\[Beta]},indexArray] FVD[p1,\[Sigma]1]FVD[p2,\[Sigma]2]FReduced[\[Mu],\[Nu],\[Sigma]1,\[Lambda]1]FReduced[\[Alpha],\[Beta],\[Sigma]2,\[Lambda]2] + m^2 CTensorGeneral[{\[Lambda]1,\[Lambda]2},indexArray] ) //Contract;
...
GravitonVectorVertex1[indexArray_,\[Lambda]1_,p1_,\[Lambda]2_,p2_] := 
	GravitonVectorVertex1[indexArray,\[Lambda]1,p1,\[Lambda]2,p2] = 
		CTensorGeneral[{\[Mu],\[Alpha],\[Nu],\[Beta]},indexArray] 1/2 FVD[p1,\[Sigma]1]FVD[p2,\[Sigma]2]FReduced[\[Mu],\[Nu],\[Sigma]1,\[Lambda]1]FReduced[\[Alpha],\[Beta],\[Sigma]2,\[Lambda]2] ;
...
GravitonVectorVertex3[indexArray_,\[Lambda]1_,p1_,\[Lambda]2_,p2_] := 
	GravitonVectorVertex3[indexArray,\[Lambda]1,p1,\[Lambda]2,p2] =  
		(-1) CTensorGeneral[{\[Sigma]1,\[Lambda]1,\[Sigma]2,\[Lambda]2},TakeLorenzIndices[indexArray]] FVD[p1,\[Sigma]1]FVD[p2,\[Sigma]2]  ;
...
GravitonVectorVertex4[indexArray_,\[Lambda]1_,p1_,\[Lambda]2_,p2_] := 
	GravitonVectorVertex4[indexArray,\[Lambda]1,p1,\[Lambda]2,p2] = 
		Map[
			( CTensorGeneral[{\[Mu],\[Nu],\[Mu]1,\[Lambda]1,\[Mu]2,\[Lambda]2},TakeLorenzIndices[#[[4;;]]]] (GammaTensor[\[Mu]1,\[Mu],\[Nu],\[Sigma],#[[1]],#[[2]]]FVD[#[[3]],\[Sigma]]FVD[p2,\[Mu]2] + GammaTensor[\[Mu]2,\[Mu],\[Nu],\[Sigma],#[[1]],#[[2]]]FVD[#[[3]],\[Sigma]]FVD[p1,\[Mu]1]) )& ,
...
GravitonVectorVertex5[indexArray_,\[Lambda]1_,p1_,\[Lambda]2_,p2_] := 
	GravitonVectorVertex5[indexArray,\[Lambda]1,p1,\[Lambda]2,p2] = 
		Map[
			( (-1/2) CTensorGeneral[{\[Mu],\[Nu],\[Alpha],\[Beta],\[Mu]1,\[Lambda]1,\[Mu]2,\[Lambda]2},TakeLorenzIndices[#[[7;;]]]] (FVD[#[[3]],\[Tau]1]FVD[#[[6]],\[Tau]2]GammaTensor[\[Mu]1,\[Mu],\[Nu],\[Tau]1,#[[1]],#[[2]]] GammaTensor[\[Mu]2,\[Alpha],\[Beta],\[Tau]2,#[[4]],#[[5]]] + FVD[#[[3]],\[Tau]2]FVD[#[[6]],\[Tau]1]GammaTensor[\[Mu]1,\[Mu],\[Nu],\[Tau]1,#[[4]],#[[5]]] GammaTensor[\[Mu]2,\[Alpha],\[Beta],\[Tau]2,#[[1]],#[[2]]] ) )&,
			Flatten/@Permutations[Partition[indexArray,3]]
		]//Total;
...
GravitonVectorGhostVertex[indexArray_,p1_,p2_] := 
	GravitonVectorGhostVertex[indexArray,p1,p2] = 
		- I (Global`\[Kappa])^(Length[indexArray]/2) FVD[p1,\[ScriptM]]FVD[p2,\[ScriptN]] CTensorGeneral[{\[ScriptM],\[ScriptN]},indexArray] //Contract;
...
GravitonVectorGhostVertexUncontracted[indexArray_,p1_,p2_] := 
	GravitonVectorGhostVertexUncontracted[indexArray,p1,p2] = 
		- I (Global`\[Kappa])^(Length[indexArray]/2) FVD[p1,Global`\[Mu]]FVD[p2,Global`\[Nu]] CTensorGeneral[{Global`\[Mu],Global`\[Nu]},indexArray] ;
