...
GravitonScalarVertexUncontracted[indexArray_,p1_,p2_,m_] := 
	GravitonScalarVertexUncontracted[indexArray,p1,p2,m] = 
		I (Global`\[Kappa])^(Length[indexArray]/2) ( - (1/2) (FVD[p1,Global`\[ScriptM]]FVD[p2,Global`\[ScriptN]]+FVD[p1,Global`\[ScriptN]]FVD[p2,Global`\[ScriptM]])CTensorGeneral[{Global`\[ScriptM],Global`\[ScriptN]},indexArray] - m^2 CTensorGeneral[{},indexArray] ) ;
...
GravitonScalarVertex[indexArray_,p1_,p2_,m_] := 
	...
	I (Global`\[Kappa])^(Length[indexArray]/2) ( - (1/2) Contract[(FVD[p1,\[ScriptM]]FVD[p2,\[ScriptN]]+FVD[p1,\[ScriptN]]FVD[p2,\[ScriptM]])CTensorGeneral[{\[ScriptM],\[ScriptN]},indexArray]] - m^2 FeynCalcInternal[CTensorGeneral[{},indexArray]] ) //Expand;
...
GravitonScalarPotentialVertexUncontracted[indexArray_,\[Lambda]_] := 
	GravitonScalarPotentialVertexUncontracted[indexArray,\[Lambda]] = 
		I (Global`\[Kappa])^(Length[indexArray]/2) \[Lambda] CTensorGeneral[{},indexArray] ;
...
GravitonScalarPotentialVertex[indexArray_,\[Lambda]_] := 
	GravitonScalarPotentialVertex[indexArray,\[Lambda]] = 
		I (Global`\[Kappa])^(Length[indexArray]/2) \[Lambda] FeynCalcInternal[CTensorGeneral[{},indexArray]] //Expand;
