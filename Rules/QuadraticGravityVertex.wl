...
VertexCurvatureSquare[gravitonParameters_List] := 
...
VertexRicciSquare[gravitonParameters_List] := 
...
QuadraticGravityVertexCore[gravitonParameters_List,m0_,m2_] := 
	QuadraticGravityVertexCore[gravitonParameters,m0,m2] = 
		GRVertex[gravitonParameters] + I (Global`\[Kappa])^(Length[gravitonParameters]/3) 1/(3 (Global`\[Kappa])^2) (2/m2^2+1/m0^2) VertexCurvatureSquare[gravitonParameters]  - I (Global`\[Kappa])^(Length[gravitonParameters]/3) 2/(Global`\[Kappa])^2 1/m2^2 VertexRicciSquare[gravitonParameters] ;


QuadraticGravityVertex[gravitonParameters_List,m0_,m2_] := 
	QuadraticGravityVertex[gravitonParameters,m0,m2] = 
		Total[
			Map[
				QuadraticGravityVertexCore[#,m0,m2]& ,
