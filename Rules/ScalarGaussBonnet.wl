...
TensorT[m_,n_,a_,b_,r_,s_,l_,t_,secondArray_List,indexArray_] := 
	TensorT[m,n,a,b,r,s,l,t,secondArray,indexArray] = 
		CTensorGeneral[Join[{m,a,n,b,s,t,r,l},secondArray],indexArray] - 4 CTensorGeneral[Join[{m,a,n,s,b,t,r,l},secondArray],indexArray] + CTensorGeneral[Join[{m,r,n,s,a,l,b,t},secondArray],indexArray];


Clear[ScalarGaussBonnetCore];

ScalarGaussBonnetCore[gravitonParameters_List] := 
...
ScalarGaussBonnet[gravitonParameters_List] := 
