...
ClearAll[CIIITensorPlain];

CIIITensorPlain[indexArrayExternal_,indexArrayInternal_] := CIIITensorPlain[indexArrayExternal,indexArrayInternal] = If[ Length[indexArrayExternal]!=6 , 0, Expand[Sum[ Power[-1,p1] ITensorPlain[ Join[indexArrayExternal[[;;2]],indexArrayInternal[[;;2p1]]] ] CIITensorPlain[indexArrayExternal[[3;;]],indexArrayInternal[[2p1+1;;]]] ,{p1,0,Length[indexArrayInternal]/2}]] ];


ClearAll[CIIITensor];

CIIITensor[indexArrayExternal_,indexArrayInternal_] := CIIITensor[indexArrayExternal,indexArrayInternal] = Expand[ 1/Power[2,Length[indexArrayInternal]/2] 1/Factorial[Length[indexArrayInternal]/2] Total[CIIITensorPlain[indexArrayExternal,#]&/@indexArraySymmetrization[indexArrayInternal]] ];
