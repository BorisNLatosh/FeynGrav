...
T3[gravitonParameters_,scalarMomenta_,b_] := 
	T3[gravitonParameters,scalarMomenta,b] = 
		If[ b!=0,
			I Power[Global`\[Kappa], Length[gravitonParameters]/3] Power[-1,b+1] b MomentaWrapper[scalarMomenta[[;;2 (b-1)]]] ( CTensorGeneral[ Join[{\[ScriptM],\[ScriptN],\[ScriptA],\[ScriptB]}, DummyArray2[b-1] ], takeIndices[gravitonParameters] ] - CTensorGeneral[ Join[{\[ScriptM],\[ScriptA],\[ScriptN],\[ScriptB]}, DummyArray2[b-1] ], takeIndices[gravitonParameters] ] ) FVD[scalarMomenta[[2b-1]],\[ScriptM]]FVD[scalarMomenta[[2b-1]],\[ScriptN]]FVD[scalarMomenta[[2b]],\[ScriptA]]FVD[scalarMomenta[[2b]],\[ScriptB]] //Expand//Contract ,
			0
		];
...
T4[gravitonParameters_,scalarMomenta_,b_] :=
	T4[gravitonParameters,scalarMomenta,b] = 
		If[
			...
			-2 b I Power[Global`\[Kappa], Length[gravitonParameters]/3] Power[-1,b+1] MomentaWrapper[scalarMomenta[[;;2 (b-1)]]] ( CTensorGeneral[ Join[{\[ScriptM],\[ScriptN],\[ScriptA],\[ScriptB],\[ScriptR],\[ScriptS]}, DummyArray2[b-1] ], takeIndices[gravitonParameters[[;;-3-1]]] ] - CTensorGeneral[ Join[{\[ScriptM],\[ScriptA],\[ScriptN],\[ScriptB],\[ScriptR],\[ScriptS]}, DummyArray2[b-1] ], takeIndices[gravitonParameters[[;;-3-1]]] ] ) FVD[gravitonParameters[[-1]],\[ScriptL]] GammaTensor[\[ScriptR],\[ScriptM],\[ScriptN],\[ScriptL],gravitonParameters[[-3]],gravitonParameters[[-2]]] FVD[scalarMomenta[[2b-1]],\[ScriptS]]FVD[scalarMomenta[[2b]],\[ScriptA]]FVD[scalarMomenta[[2b]],\[ScriptB]] //Expand//Contract,
			0
		];
