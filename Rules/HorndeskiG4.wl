...
HorndeskiG4Core[gravitonParameters_,scalarMomenta_,b_] := HorndeskiG4Core[gravitonParameters,scalarMomenta,b] = T1[gravitonParameters,scalarMomenta,b]+T2[gravitonParameters,scalarMomenta,b]+T3[gravitonParameters,scalarMomenta,b]+T4[gravitonParameters,scalarMomenta,b]+T5[gravitonParameters,scalarMomenta,b];
...
HorndeskiG4[gravitonParameters_,scalarMomenta_,b_] := HorndeskiG4[gravitonParameters,scalarMomenta,b] = If[ b==0, HorndeskiG4Core[gravitonParameters,scalarMomenta,b] , Plus @@ ( HorndeskiG4Core[gravitonParameters,#,b]& /@  Permutations[scalarMomenta] )];
