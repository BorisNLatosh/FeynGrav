...
T5[gravitonParameters_,scalarMomenta_,b_] := 
	T5[gravitonParameters,scalarMomenta,b] = 
		(-1/3) MomentaWrapper[scalarMomenta[[;;2(b-1)]]] FVD[scalarMomenta[[2b-1]],\[Mu]]FVD[scalarMomenta[[2b-1]],\[Nu]]FVD[scalarMomenta[[2b]],\[Alpha]]FVD[scalarMomenta[[2b]],\[Beta]]FVD[scalarMomenta[[2b+1]],\[Rho]]FVD[scalarMomenta[[2b+1]],\[Sigma]] (CTensorGeneral[ Join[{\[Mu],\[Nu],\[Alpha],\[Beta],\[Rho],\[Sigma]}, DummyArray2[b-1]], takeIndices[gravitonParameters]] - 3 CTensorGeneral[ Join[{\[Mu],\[Nu],\[Alpha],\[Rho],\[Beta],\[Sigma]}, DummyArray2[b-1]], takeIndices[gravitonParameters]] + 2 CTensorGeneral[ Join[{\[Nu],\[Alpha],\[Beta],\[Rho],\[Sigma],\[Mu]}, DummyArray2[b-1]], takeIndices[gravitonParameters]]);
...
T6[gravitonParameters_,scalarMomenta_,b_] := 
	T6[gravitonParameters,scalarMomenta,b] = 
		MomentaWrapper[scalarMomenta[[;;2(b-1)]]] FVD[scalarMomenta[[2b-1]],\[Tau]]FVD[scalarMomenta[[2b]],\[Alpha]]FVD[gravitonParameters[[-1]],\[Lambda]]FVD[scalarMomenta[[2b]],\[Beta]]FVD[scalarMomenta[[2b+1]],\[Rho]]FVD[scalarMomenta[[2b+1]],\[Sigma]] GammaTensor[\[Omega],\[Mu],\[Nu],\[Lambda],gravitonParameters[[-3]],gravitonParameters[[-2]]] (CTensorGeneral[ Join[{\[Mu],\[Nu],\[Alpha],\[Beta],\[Rho],\[Sigma],\[Omega],\[Tau]}, DummyArray2[b-1]], takeIndices[gravitonParameters[[;;-1-3]]]] - 3 CTensorGeneral[ Join[{\[Mu],\[Nu],\[Alpha],\[Rho],\[Beta],\[Sigma],\[Omega],\[Tau]}, DummyArray2[b-1]], takeIndices[gravitonParameters[[;;-1-3]]]] + 2 CTensorGeneral[ Join[{\[Nu],\[Alpha],\[Beta],\[Rho],\[Sigma],\[Mu],\[Omega],\[Tau]}, DummyArray2[b-1]], takeIndices[gravitonParameters[[;;-1-3]]]]);
