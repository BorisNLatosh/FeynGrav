...
GravitonGhostVertex2alpha = {indexArray,\[Mu],p1,\[Nu],p2}|->I (Global`\[Kappa])^(Length[indexArray]/3) 1/2 CITensor[{\[Rho],\[Sigma]},TakeLorenzIndices[indexArray[[4;;]]]]FVD[indexArray[[3]],\[Lambda]](FVD[p1,\[Sigma]]ReducedGamma[\[Mu],\[Rho],\[Nu],\[Lambda],indexArray[[1]],indexArray[[2]]]+FVD[p2,\[Sigma]]ReducedGamma[\[Nu],\[Rho],\[Mu],\[Lambda],indexArray[[1]],indexArray[[2]]])//Calc;
GravitonGhostVertex2 = {indexArray,\[Mu],p1,\[Nu],p2} \[Function] Total[GravitonGhostVertex2alpha[#,\[Mu],p1,\[Nu],p2]&/@indexSymmetrization[indexArray]]//Calc;
GravitonGhostVertex3alpha = {indexArray,\[Mu],p1,\[Nu],p2}|->I 1/4 (Global`\[Kappa])^(Length[indexArray]/3) CIITensor[{\[Alpha],\[Beta],\[Rho],\[Sigma]},TakeLorenzIndices[indexArray[[7;;]]]]FVD[indexArray[[3]],\[Lambda]1]FVD[indexArray[[6]],\[Lambda]2]ReducedGamma[\[Rho],\[Alpha],\[Mu],\[Lambda]1,indexArray[[1]],indexArray[[2]]]ReducedGamma[\[Sigma],\[Beta],\[Nu],\[Lambda]2,indexArray[[4]],indexArray[[5]]]//Calc;
GravitonGhostVertex3 = {indexArray,\[Mu],p1,\[Nu],p2} \[Function] Total[GravitonGhostVertex3alpha[#,\[Mu],p1,\[Nu],p2]&/@indexSymmetrization[indexArray]]//Calc;
GravitonGhostVertex4alpha = {indexArray,\[Mu],p1,\[Nu],p2}|->I (Global`\[Kappa])^(Length[indexArray]/3) CITensor[{\[Alpha],\[Beta]},TakeLorenzIndices[indexArray[[4;;]]]]FVD[indexArray[[3]],\[Lambda]]ReducedGamma[\[Mu],\[Alpha],\[Nu],\[Lambda],indexArray[[1]],indexArray[[2]]] FVD[p2,\[Beta]]//Calc;
GravitonGhostVertex4 = {indexArray,\[Mu],p1,\[Nu],p2} \[Function] Total[GravitonGhostVertex4alpha[#,\[Mu],p1,\[Nu],p2]&/@indexSymmetrization[indexArray]]//Calc;
GravitonGhostVertex5alpha = {indexArray,\[Mu],p1,\[Nu],p2}|->I 1/2 (Global`\[Kappa])^(Length[indexArray]/3) CIITensor[{\[Alpha],\[Beta],\[Rho],\[Sigma]},TakeLorenzIndices[indexArray[[7;;]]]]FVD[indexArray[[3]],\[Lambda]1]FVD[indexArray[[6]],\[Lambda]2]ReducedGamma[\[Mu],\[Alpha],\[Sigma],\[Lambda]1,indexArray[[1]],indexArray[[2]]]ReducedGamma[\[Rho],\[Beta],\[Nu],\[Lambda]2,indexArray[[4]],indexArray[[5]]]//Calc;
GravitonGhostVertex5 = {indexArray,\[Mu],p1,\[Nu],p2} \[Function] Total[GravitonGhostVertex5alpha[#,\[Mu],p1,\[Nu],p2]&/@indexSymmetrization[indexArray]]//Calc;
